...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Portfolio for Kevin Han">
    <meta name="author" content="Wenkai Han">

    <title>Kevin Han</title>
    ...
    <script> 
      $(document).ready(function(){
          $("#know").click(function(){
              $("#panel").fadeToggle();//show more information when "know more" is clicked
          });
      });
    </script>
  </head>
  ...
  <body class="text-center">
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      <header class="masthead mb-auto">
        <div class="inner">
          <h3 class="masthead-brand"><a  href="index.html">Kevin Han</a></h3>
      ...
      <footer class="mastfoot mt-auto">
        <div class="inner">
          <p>Portfolio for <a href="https://WenkaiHan.com/">Kevin Han</a></p>
        </div>
      </footer>
    </div>
